    ...
    <div class="sub-nav-inner">
        <div class="container">
            ...
            <div class="navbar navbar-inverse">
                <div class="navbar-inner">
                    <ul class="nav">
                        <?php if(is_array($site)): $i = 0; $__LIST__ = $site;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["type"] == 2 ): ?><li><a href="__ROOT__/Site/listTpl/id/<?php echo ($vo["id"]); ?>.html"><?php echo ($vo["title"]); ?></a></li>
                        <?php else: ?>
                        <li><a href="__ROOT__/Site/page/id/<?php echo ($vo["id"]); ?>.html"><?php echo ($vo["title"]); ?></a></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
            </div>
            <!--end: Navigation -->
...
<div class="container paddtop">
    <!--内容 start-->
     <h3 class="text-center"><?php echo ($list['title']); ?></h3> 
     <hr>
     <div>
