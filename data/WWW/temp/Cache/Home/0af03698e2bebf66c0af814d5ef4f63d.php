...
<div class="container paddtop">
    ...
    <div  id="content" class="span12">
        ...
        <p class="center_uname">
            ...
            &nbsp;
            <?php if($list["video_audit"] > 1): ?><a class="icon icon-orange icon-comment-video" href="__ROOT__/Center/approve/video.html"  data-rel="tooltip" title="视频已认证"></a>
            <?php else: ?>
            <a class="icon icon-comment-video" href="__ROOT__/Center/approve/video.html" data-rel="tooltip" title="视频未认证"></a><?php endif; ?>
            &nbsp;
            <?php if($list["site_audit"] > 1): ?><a class="icon icon-orange icon-users" href="__ROOT__/Center/approve/scene.html"  data-rel="tooltip" title="现场已认证"></a>
            <?php else: ?>
            <a class="icon icon-users" href="__ROOT__/Center/approve/scene.html" data-rel="tooltip" title="现场未认证"></a><?php endif; ?>
            &nbsp;
            <?php if($list["cellphone_audit"] > 1): ?><a class="icon icon-orange icon-cellphone ajax-link" href="__ROOT__/Center/approve/cellphone.html"  data-rel="tooltip" title="手机已认证"></a>
            <?php else: ?>
            <a class="icon icon-cellphone ajax-link" href="__ROOT__/Center/approve/cellphone.html" data-rel="tooltip" title="手机未认证"></a><?php endif; ?>
        </p>
        <div class="popover bottom center_popove_b">
            <div class="popover-content">
              ...
              <div class="right">
              	<a href="__ROOT__/Center/fund/mid/inject.html" class="btn btn-warning">充值</a>
                <a href="__ROOT__/Center/fund/mid/draw.html" class="btn btn-primary">提现</a>
              </div>
            </div>
        </div>
    </div>
        ...
        <div class="span3">
            <div class="widget widget-table">
                <div class="widget-header">
                    <h3>投资者</h3>
                    <span><a href="__ROOT__/Center/invest/mid/isclosed.html" title="查看详情"><i class="icon-list"></i></a></span>
                </div>
                <div class="widget-content">
                    <table class="table">
                        ...
                        <tbody>
                                    <tr>
                                        <td><a href="__ROOT__/Center/invest/mid/isclosed.html">回款中</a></td>
                                        <td><?php echo (($investment["returned"])?($investment["returned"]):"0"); ?></td>
                                        <td style="text-align: right"><?php echo (number_format($investment["returned_total"],2,'.',',')); ?></td>
                                    </tr>
                                    <tr>
                                        <td><a href="__ROOT__/Center/invest/mid/overdue.html">逾期中</a></td>
                                        <td><?php echo (($investment["overdueReturned"])?($investment["overdueReturned"]):"0"); ?></td>
                                        <td style="text-align: right"><?php echo (number_format($investment["overdueReturned_total"],2,'.',',')); ?></td>
                                    </tr>
                        </tbody>
                    </table>
                </div>
