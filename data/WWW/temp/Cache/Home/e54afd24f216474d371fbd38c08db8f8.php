...
<ul class="center_secondary">
    <li <?php if(($mid) == "personal_data"): ?>class="active"<?php endif; ?>><a href="__ROOT__/Center/basic/personal_data.html">个人资料</a></li>
    <li><a href="__ROOT__/Home/Center/portrait.html">头像</a></li>
</ul>
<!-- 二级end-->
    <div id="content" class="center_zt">
      	<?php switch($mid): case "personal_data": ?><!--个人资料 start-->
			 <form method="post"  action='__URL__/tfUpda'>
             	<input name="q" type="hidden" value="ufo" />
                <input name="u" type="hidden" value="__ROOT__/Center/basic/personal_data.html" />
                <input name="g" type="hidden" value="uid" />
                <input name="sid" type="hidden" value="<?php echo (session('user_uid')); ?>" />
<?php if(is_array($userinfo)): $i = 0; $__LIST__ = $userinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><table class="table">
                    <tbody>
                        <tr>
                            <td>*所在地址：</td>
                            <td  class="form-inline" id="area">
                            	<?php if($v["location"] == ''): ?>省份 <select id="province"  name="location[]" style="width:100px;"></select> 城市 <select id="city" style="width:110px;"  name="location[]"></select>	区/县 <select id="county"  style="width:140px;" name="location[]"></select>
                                <?php else: ?>
                                	<span id="show"><?php echo ($v["location"]); ?>&nbsp;&nbsp;<a href="#" onclick="$('#show').toggle();$('#location').toggle();$('#province').attr({ name: 'location[]'});$('#city').attr({ name: 'location[]'});$('#county').attr({ name: 'location[]'});">更换</a></span>
									<span id="location" style="display: none;">省份 <select id="province"   style="width:100px;"></select> 城市 <select id="city" style="width:110px;"  ></select>	区/县 <select id="county"  style="width:140px;"></select></span><?php endif; ?>
                            </td>
                         </tr>
                         <tr>
                            <td>婚姻状况：</td>
                            <td class="form-inline">
                            	<label class="radio"><input type="radio" name="marriage" value="0" <?php if(($v["marriage"]) == "0"): ?>checked<?php endif; ?>/> 保密</label>
                                <label class="radio"><input type="radio" name="marriage" value="1" <?php if(($v["marriage"]) == "1"): ?>checked<?php endif; ?>/> 未婚</label>
                                <label class="radio"><input type="radio" name="marriage" value="2" <?php if(($v["marriage"]) == "2"): ?>checked<?php endif; ?>/> 已婚</label>
                            </td>
                         </tr>
                         <tr>
                            <td>学历：</td>
                            <td>
                            	<select name="education" style="width:100px;">  
                                		...
                                		<?php if(is_array($education)): $i = 0; $__LIST__ = $education;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["value"] == $v["education"] ): ?><option value='<?php echo ($vo["value"]); ?>' selected><?php echo ($vo["name"]); ?></option>
                                                <?php else: ?>
                         ...
                         <tr>
                            <td>月收入：</td>
                            <td>
                            	<select name="monthly_income" style="width:140px;">   
                                        <option value='0' >保密</option>
                                        <?php if(is_array($monthly_income)): $i = 0; $__LIST__ = $monthly_income;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["value"] == $v["monthly_income"] ): ?><option value='<?php echo ($vo["value"]); ?>' selected><?php echo ($vo["name"]); ?></option>
                                                <?php else: ?>
                                                <option value='<?php echo ($vo["value"]); ?>' ><?php echo ($vo["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </td>
                         ...
                         <tr>
                            <td>住房条件：</td>
                            <td>
                            	<select name="housing" style="width:120px;">   
                                        <option value='0' >保密</option>
                                        <?php if(is_array($housing)): $i = 0; $__LIST__ = $housing;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["value"] == $v["housing"] ): ?><option value='<?php echo ($vo["value"]); ?>' selected><?php echo ($vo["name"]); ?></option>
                                                <?php else: ?>
                                                <option value='<?php echo ($vo["value"]); ?>' ><?php echo ($vo["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </td>
                         ...
                         <tr>
                            <td>购车情况：</td>
                            <td>
                            	<select name="buy_cars" style="width:120px;">   
                                        <option value='0' >保密</option>
                                        <?php if(is_array($buy_cars)): $i = 0; $__LIST__ = $buy_cars;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["value"] == $v["buy_cars"] ): ?><option value='<?php echo ($vo["value"]); ?>' selected><?php echo ($vo["name"]); ?></option>
                                                <?php else: ?>
                                                <option value='<?php echo ($vo["value"]); ?>' ><?php echo ($vo["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </td>
                         ...
                         <tr>
                            <td>*QQ：</td>
                            <td><input name="qq" type="text" class="span4" value="<?php echo ($v["qq"]); ?>"/></td>
                         </tr>
                         <tr>
                            <td>*固定电话：</td>
                            <td><input name="fixed_line" type="text" class="span4" value="<?php echo ($v["fixed_line"]); ?>"/></td>
                         </tr>
                         <tr>
                            <td>当前所在行业：</td>
                            <td>
                            	<select name="industry" style="width:120px;">   
                                        <option value='0' >保密</option>
                                        <?php if(is_array($industry)): $i = 0; $__LIST__ = $industry;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["value"] == $v["industry"] ): ?><option value='<?php echo ($vo["value"]); ?>' selected><?php echo ($vo["name"]); ?></option>
                                                <?php else: ?>
                                                <option value='<?php echo ($vo["value"]); ?>' ><?php echo ($vo["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </td>
                         ...
                         <tr>
                            <td>公司：</td>
                            <td><input name="company" type="text" value="<?php echo ($v["company"]); ?>"/></td>
                         </tr>
                         <tr>
                            <td></td>
                            <td>
